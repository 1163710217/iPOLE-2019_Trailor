...
class FakeJobFlow(object):
    def __init__(self, job_id, name, log_uri, job_flow_role, visible_to_all_users, steps, instance_attrs, emr_backend):
        ...
        self.initial_main_instance_type = instance_attrs.get('main_instance_type')
        self.initial_subordinate_instance_type = instance_attrs.get('subordinate_instance_type')
    ...
    def main_instance_type(self):
        ...
        if groups:
            ...
            return self.initial_main_instance_type
    ...
    def subordinate_instance_type(self):
        ...
        if groups:
            ...
            return self.initial_subordinate_instance_type
